...
const FeedPageV2: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0f172a] transition-colors flex flex-col">
      ...
      <main data-fab-scroll-container className="flex-1 overflow-y-auto">
          ...
          <section className="grid grid-cols-1 gap-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="flex flex-col rounded-2xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-900 p-4">
                <div className="flex items-center gap-1.5 text-[10px] font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500 mb-3">
                  <Calendar size={11} />
                  오늘
                </div>
                <div className="space-y-2">
                  <div className="flex items-baseline gap-1.5">
                    ...
                    <span className="text-xs text-slate-400 dark:text-slate-500">일정</span>
                  </div>
                  <div className="flex items-baseline gap-1.5">
                    <span className="text-base font-bold text-slate-900 dark:text-white">{todayRecords}개</span>
                    <span className="text-xs text-slate-400 dark:text-slate-500">기록</span>
                  </div>
                </div>
              ...
              <div className="flex flex-col rounded-2xl border border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-900 p-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-baseline gap-1.5">
                    ...
                    <span className="text-xs text-slate-400 dark:text-slate-500">연속</span>
                  </div>
                </div>
