    ...
    <div className="flex-1 space-y-2">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        ...
        <button
          ...
          onClick={submit}
          disabled={!input.trim()}
          className="w-full rounded-xl bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-600 transition-colors hover:bg-slate-200 disabled:opacity-40 dark:bg-slate-700 dark:text-slate-300 dark:hover:bg-slate-600 sm:w-auto"
        >
          추가
        </button>
      </div>
